    ...
    return (
        <div className='login'>
             ...
             <div className='login__container'>
                    ...
                    <p>By signing-in you agree to AMAZON UNREGISTERED CLONE Conditions of Use & Sale.<br/>
